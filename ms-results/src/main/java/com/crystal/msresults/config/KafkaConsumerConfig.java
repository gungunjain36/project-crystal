...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, ScanResultMessage> consumerFactory() {
        JsonDeserializer<ScanResultMessage> deserializer = new JsonDeserializer<>(ScanResultMessage.class, false);
        deserializer.addTrustedPackages("com.crystal.msresults.model.dto");
